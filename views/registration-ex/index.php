...
/* @var $searchModel app\models\RegistrationExSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Registration Exes');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="registration-ex-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Registration Ex'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
